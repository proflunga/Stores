 							...
 							<div class="card-body">
 								...
 								<div class="row ">
 									...
 									<div class="col-md-4 mb-10">
 										...
 										<input required type="text" name="first_name" class="form-control mb-2 mb-md-0">
 									</div>
 									<div class="col-md-4 mb-10">
 										<label class="form-label"> Middle Name:</label>
 										<input type="text" name="middle_name" class="form-control mb-2 mb-md-0">
 									</div>
 									<div class="col-md-4 mb-10">
 										<label class="form-label"> Last Name:</label>
 										<input required type="text" name="last_name" class="form-control mb-2 mb-md-0">
 									</div>
 									<div class="col-md-4 mb-10">
 									...
 									<div class="col-md-4 mb-10">
 										...
 										<input required type="date" name="birth_date" class="form-control mb-2 mb-md-0">
 									</div>
 								</div>
 							...
 							<div class="card-body">
 								<div class="row">
 									...
 									<div class="col-md-6 mb-10">
 										...
 										<input required type="text" name="address_line1" class="form-control mb-2 mb-md-0">
 									</div>
 									<div class="col-md-6 mb-10">
 										<label class="form-label"> Address Line 2:</label>
 										<input required type="text" name="address_line2" class="form-control mb-2 mb-md-0">
 									</div>
 									<div class="col-md-6 mb-10">
 									...
 									<div class="col-md-4 mb-10">
 										...
 										<input required type="text" name="mobile_number" class="form-control mb-2 mb-md-0">
 									</div>
 									<div class="col-md-4 mb-10">
 										<label class="form-label"> Telephone Number:</label>
 										<input required type="text" name="telephone_number" class="form-control mb-2 mb-md-0">
 									</div>
 									<div class="col-md-4 mb-10">
 										<label class="form-label"> National ID:</label>
 										<input required type="text" name="national_id" class="form-control mb-2 mb-md-0">
 									</div>
 								</div>
 							...
 							<div class="card-body">
 								...
 								<div class="row">
 									...
 									<div class="col-md-4 mb-10">
 										...
 										<input required type="email" name="email" class="form-control mb-2 mb-md-0">
 									</div>
