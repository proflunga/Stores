...
if (isset($_POST['approve_new_user']) || isset($_POST['activate_user']) || isset($_POST['deactivate_user'])) {
	...
	<div class="toolbar" id="kt_toolbar">
		...
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			...
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				<!--begin::Title-->
				<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Account Status
					<!--begin::Separator-->
			...
			<div class="row g-5 g-xl-8">
				...
				<div class="col-xl-12">
					...
					if ($row_admin['account_status'] == 0 and $row_admin['new_account_flag'] == 1) {
						// new account
						require 'includes/admin-card-approve.php';
					} else if ($row_admin['account_status'] == 0) {
						require 'includes/admin-card-activate.php';
					} else {
						//  deactivate
						require 'includes/admin-card-deactivate.php';
					}
