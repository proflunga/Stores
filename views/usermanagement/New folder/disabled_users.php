                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                   ...
                   <div class="py-0">
                      ...
                      <h4 class="anchor fw-bolder mb-5" id="buttons">
                         ...
                         <span class="badge badge-danger me-10 mb-10">Deactivated Accounts</span>
                      </h4>
                      <!--end::Heading-->
                      <!--begin::Block-->
                      <!--end::Block-->
                                  ...
                                  <div class="table-responsive">
                                     <table class="table align-middle border rounded table-row-dashed fs-6 g-5 dataTable no-footer" id="kt_datatable_example_1">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                           <?php
                                             $sql = "SELECT users_portal.id,users_portal.client_type,users_portal.client_id,users_portal.username ,employers.legal_name FROM users_portal INNER JOIN employers on employers.id = users_portal.client_id WHERE users_portal.status_active = 0 and users_portal.new_account_status = 0 ";
                                             ...
                                             if (!$result) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                          		...
                                          		<td>' . $client_id . '</td>  
                                          		<td>' . $username . '</td>  
                                          		<td><a href="controllers/usermanagement/portal_users.php?action=activate_user&u_id=' . $user_id . '" class="btn btn-sm btn-success btn-hover-scale me-5"><i class="fa fa-check fs-4 me-2"></i>Activate</a></td>  
                                          	 </tr>
                                          		';
                                                }
                                             }
