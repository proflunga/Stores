	...
	<div class="toolbar" id="kt_toolbar">
		...
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			...
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				<!--begin::Title-->
				<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Account Details
					<!--begin::Separator-->
								...
								<div class="form-group row g-3">
									<div class="row">
										...
										<div class="col-md-4 mb-10">
											...
											<input required type="text" value="<?php echo $row_admin['username'] ?>" name="username" class="form-control mb-2 mb-md-0">
										</div>
										<div class="col-md-4 mb-10">
											<label class="form-label"> Email:</label>
											<input required type="email" value="<?php echo $row_admin['user_email'] ?>" name="email" class="form-control mb-2 mb-md-0">
										</div>
									</div>
								</div>
