...
<?php require 'controllers/inventory/products.variance_update.php'; ?>
				...
				<div class="toolbar" id="kt_toolbar">
					...
					<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
						...
						<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
							<!--begin::Title-->
							<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Variance 
							<!--begin::Separator-->
							<span class="h-20px border-1 border-gray-200 border-start ms-3 mx-2 me-1"></span>
							<!--end::Separator-->
							<!--begin::Description-->
							<span class="text-muted fs-7 fw-bold mt-2">Home > Variance</span>
							<!--end::Description--></h1>
							<!--end::Title-->
						</div>
						<!--end::Page title-->
						...
						<div class="d-flex align-items-center gap-2 gap-lg-3">
							<!-- include menu ******************* -->
								<script> 
									$(function(){
										$("#div_include").load("views/inventory/includes/menu.variance.html"); 
									});
								</script>    
								<div id="div_include">        
								</div>    
		...
		<div class="row g-5 g-xl-8">
			...
			<form action="" method="POST">
						...
						<div class="card-body pt-0">
							...
							<div class="mb-10 row">
								<div class="col-md-6 col-lg-6 col-12">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" readonly style="background: #e4e6ef;" id="prod_name_id" class="form-control mb-2" placeholder="Product name" value="" />
									<!--end::Input-->
									<!--begin::Description-->
								...
								<div class="col-md-6 col-lg-6 col-12 lg-my-0 md-my-0 sm-my-3 ">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" readonly style="background: #e4e6ef;" id="prod_code_id" class="form-control mb-2" placeholder="Product code" value="" />
									<!--end::Input-->
									<!--begin::Description-->
								...
								<div class="col-md-6 col-lg-6 col-12 lg-my-0 md-my-0 my-3">
									<!--begin::Label-->
									<label class="required form-label">Old Quantity</label>
									<!--end::Label-->
									<!--begin::Input-->
									<input type="number" readonly style="background: #e4e6ef;"  id="prod_quantity_id" class="form-control mb-2" placeholder="Product Quaantity" value="" />
									<!--end::Input-->
									<!--begin::Description-->
								...
								<!--begin::Input group-->
							<div class="col-md-6 col-lg-6 col-12 lg-my-0 md-my-0 my-3">
								<label class="fs-6 form-label fw-bolder text-dark">New Quantity</label>
								<input type="number" class="form-control form-control form-control-solid" name="product_quantity"> </div>
							<!--end::Input group-->
							</div>
							<!--end::Input group-->
				...
				<div class="d-flex align-items-center justify-content-center mt-5">
								<button type="submit" name="variance_update" class="btn  btn-hover-scale btn-primary"> Set Product Quantity</button>
							</div>
							<!--end::Action-->
