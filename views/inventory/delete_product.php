...
require 'controllers/inventory/products.delete_product.controller.php';
	...
	<div class="toolbar" id="kt_toolbar">
		...
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			...
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				<!--begin::Title-->
				<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Delete Product
					<!--begin::Separator-->
					<span class="h-20px border-1 border-gray-200 border-start ms-3 mx-2 me-1"></span>
					<!--end::Separator-->
					<!--begin::Description-->
					<span class="text-muted fs-7 fw-bold mt-2">Home > Products >Delete Product</span>
					<!--end::Description-->
				</h1>
				<!--end::Title-->
			</div>
			...
			<div class="d-flex align-items-center gap-2 gap-lg-3">
				...
				<script>
					$(function() {
						$("#div_include").load("views/inventory/includes/menu.delete_product.html");
					});
				</script>
				<div id="div_include">
				</div>
						...
						<form action="" method="POST">
							...
							<div class="mb-1">
								...
								<div class="d-flex align-items-center justify-content-center mt-5">
									<button type="submit" name="delete_product" class="btn  btn-hover-scale btn-danger">
										<li class="fa fa-trash"></li> &nbsp; Delete Product
									</button>
								</div>
								<!--end::Action-->
							</div>
...
<script>
	...
	$(document).ready(function() {
		...
		$inventory_obj->product_data_delete($prod_id)
		?>
