            ...
            <div class="content flex-row-fluid" id="kt_content">
                ...
                <div class="row">
                    <div class="col-xl-3">
                        ...
                        <a href="inquiries.php?action=pending_inquiries" class="card bg-primary hoverable card-xl-stretch mb-5 mb-xl-8">
                            <!--begin::Body-->
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-white fw-bolder fs-2 mb-2 mt-5">Inquiries</div>
                                <div class="fw-bold text-white">Pending, Archived...</div>
                            </div>
                            <!--end::Body-->
                        </a>
...
<script>
    <?php
    $inquiries_obj->fetch_pending_inquiries_count()
    ?>
