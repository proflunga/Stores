 ...
 <head>
     ...
     <?php
        ...
        page_validation($user_id, $db_query_obj, 'billing');
        ?>
 </head>
 <!--end::Head-->
 <!--begin::Body-->
                 ...
                 <?php
                    if (isset($_GET['action'])) {
                        if ($_GET['action'] == 'invoices') {
                            require 'views/billing/invoices.php';
                        } elseif ($_GET['action'] == 'generate_invoice') {
                            require 'views/billing/generate_invoice.php';
                        } else {
                            goto _default;
                        }
                    } else {
                        _default:
                        require 'views/billing/billing.php';
                    }
